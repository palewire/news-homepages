...
As part of its archiving routine, our system conducts routine audits of code quality using [Google's open-source Lighthouse tool](https://developer.chrome.com/docs/lighthouse/overview/). This page

<tableclass="colwidths-auto docutils align-default">
 <thead>
  <tr>
    <th class="head text-left">Rank</th>
    <th class="head text-left">Site</th>
    <th class="text-right head">Median score</th>
  </tr>
 </thead>
 <tbody>
  ...
  <tr>
    ...
    <td class="text-right" style="background-color: green; color: white;">
        100
    </td>
  </tr>
  ...
  <tr>
    ...
    <td class="text-right" style="background-color: orange; color: white;">
        89
    </td>
  </tr>
  ...
  <tr>
    <td class="text-left">170</td>
    <td class="text-left">
        <a href="https://palewi.re/docs/news-homepages/sites/thegrio.html">
            Grio
        </a>
    </td>
    <td class="text-right" style="background-color: red; color: white;">
        49
    </td>
  </tr>
